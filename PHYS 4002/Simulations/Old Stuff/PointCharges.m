...
Nx1 = 551; 
Nx2 = Nx1 + 210;      % must add an EVEN number
Ny1 = 61;  
Ny2 = Ny1 + 730;      % must add an EVEN number
...
figure(9)
    set(gcf,'units','normalized','position',[0.73 0.1 0.23 0.32]); 
    hold on
    % Plot electric field in 3-d using streamslice or quiver3
    % Need: 
    %   electric field points (x, y, z)
    %   electric field directions (Ex, Ey, Ez)
